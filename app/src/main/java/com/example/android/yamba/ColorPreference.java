...
public class ColorPreference extends DialogPreference {
    ...
    public ColorPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        //Get the default color from the current theme
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        View rootView = LayoutInflater.from(getContext())
                .inflate(R.layout.preference_color, null);
    ...
    protected void onSetInitialValue(boolean restorePersistedValue,
        ...
        setCurrentValue(restorePersistedValue ?
                getPersistedInt(mDefaultColor) : (Integer) defaultValue);
    }
    ...
    public CharSequence getSummary() {
        ...
        int color = getPersistedInt(mDefaultColor);
